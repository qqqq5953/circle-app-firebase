...
<script>
import NavbarComponent from '../components/ref/Navbar.vue';
import SidebarComponent from '../components/ref/Sidebar.vue';
import LineChartComponent from '../components/ref/LineChart.vue';
import BarChartComponent from '../../components/ref/BarChart.vue';
export default {
  name: 'dashboard-page',
  components: {
    NavbarComponent,
